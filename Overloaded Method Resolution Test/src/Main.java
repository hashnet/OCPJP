public class Main {
	...
	public static void printAutoBox(Integer i) {
	...
	public static void printVarArg(byte... b) {
		System.out.println("VarArg bytes: " + b);
	}
	...
	//Null object check
	public static void printNull(Integer i) {
		System.out.println("Null Integer: " + i);
	}	
	public static void printNull(Byte b) {
	...
	public static void main(String[] args) {
		...
		printLarge(b2);		//prints: Large doule: 2.0
							//(b2 is first autounboxed to byte)
		...
		//Matching Autoboxed Type of overloaded method parameters
		printAutoBox(b1);	//AutoBox long: 1
		printAutoBox(i1);	//prints: AutoBox long: 5
							//Larger Primitive has higher preference than autoboxing
		//printAutoBox(f1);	//The method printAutoBox(Integer) in the type Main is not applicable for the arguments (float)
		...
		printVarArg();		//VarArg bytes: [B@5c647e05 (Varargs with the smallest primitive type)
		...
		//Matching null objects
		//printNull(null);	//Compilation fails. The method printNull(Integer) is ambiguous for the type Main
	}
}